...
###########################################################################
#
# modified 2018.02.07 by Yannick Jadoul
# Changes:
# + replaced "directory" parameter by "fileName" and removed loop over
#     all files in the directory to a single execution of the algorithm
#     over this one file
# + removed output in CSV format
# + removed the 'Keep_Soundfiles_and_Textgrids' argument
# + selected sound plus textgrid at the end of the script
#
###########################################################################
