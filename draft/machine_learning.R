...
# functions
source('../../../Dropbox/[D] Filipe Zabala/pacotes/voice/expand_model.R')
source('../../../Dropbox/[D] Filipe Zabala/pacotes/voice/class_svm.R')
source('../../../Dropbox/[D] Filipe Zabala/pacotes/voice/write_list.R')
