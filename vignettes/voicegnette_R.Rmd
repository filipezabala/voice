...
### 3.1 Get audio
```{r, message=FALSE, warning=FALSE}
url0 <- 'https://github.com/filipezabala/voiceAudios/raw/refs/heads/main/mp3/doremi.mp3'
...
#### 3.6.2 Notes sequences of f0 and f1
```{r, message=FALSE, warning=FALSE}
line_0 <- gm::Line(as.character(f0_spn))
...
### 4.2 MacOS
The following steps are used to fully configure `voice` on [MacOS Sonoma](https://www.apple.com/macos/sonoma/). Reports of inconsistencies are welcome.
