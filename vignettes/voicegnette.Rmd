...
#### To do #10 [TESTED: OK]
Automatize and test `autoDir` argument.
...
ef_sm <- smooth_df(ef)
```
#### To do #40 [DONE. VERSION 0.0.0.9042]
...
#### To do #130 [DEPRECATED]
[DEPRECATED] Automate argument `compact.to` at `voice::conv_df`. 

#### To do #140 [TESTED: NOK WITH GAIN]
...
- [TESTED: OK] During the tests all the problems were solved.
